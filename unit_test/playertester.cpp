...
{
    Hero player = Hero::parse("../json_files/Dark_Wanderer.json");
...
TEST(PlayerTest, PlayerAttack)
{
    ...
    Hero A = Hero::parse("../json_files/Dark_Wanderer.json");
    Monster B = Monster::parse("../json_files/Fallen.json");
...
{
    Hero A = Hero::parse("../json_files/Dark_Wanderer.json");
    Monster B = Monster::parse("../json_files/Blood_Raven.json");
    A.Attack(B);
    A.Attack(B);
    A.Attack(B);
    A.Attack(B);
